...
public class GameController : MonoBehaviour {
	...
	void CargarDatosReceta(){
		...
		receta.add (new RecetaMedida (5,"unidades","Hielo","UtencilioOrigenCesta","UtencilioDestinoCoctelera","Poner",1,0));
		receta.add (new RecetaMedida (0.6f,"onza","Pisco","UtencilioOrigenJarra","UtencilioDestinoCoctelera","Vertir",0.1f,5));
		receta.add (new RecetaMedida (0.3f,"onza","Jugo de Limon","UtencilioOrigenJarra","UtencilioDestinoCoctelera","Vertir",0.1f,5));
		receta.add (new RecetaMedida (0.3f,"onza","Jarabe de Goma","UtencilioOrigenJarra","UtencilioDestinoCoctelera","Vertir",0.1f,5));
		receta.add (new RecetaMedida (0.25f,"onza","Clara de Huevo","UtencilioOrigenJarra","UtencilioDestinoCoctelera","Vertir",0.1f,5));
		//receta.add (new RecetaMedida (0.25f,"onza","Clara de Huevo","UtencilioOrigenJarra","UtencilioDestinoCoctelera","Vertir",0.1f,5));
		receta.add (new RecetaMedida (10,"segundos","Coctelera Tapa","UtencilioOrigenCoctelera","UtencilioDestinoCoctelera","Batir",1,0));
